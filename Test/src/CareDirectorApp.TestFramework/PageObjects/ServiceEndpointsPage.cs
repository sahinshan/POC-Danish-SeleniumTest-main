...
{
    public class ServiceEndpointsPage
    {
        ...
        public ServiceEndpointEditPage tapAddNewServiceEndpointButton()
        {
            _app.Tap(_addNewServiceEndpointButton);

            return new ServiceEndpointEditPage(_app);
        }

        public ServiceEndpointEditPage TapOnServiceEndpoint(string ServiceEndpointName)
        {
