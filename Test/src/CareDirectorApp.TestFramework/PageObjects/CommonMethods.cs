...
namespace CareDirectorApp.TestFramework.PageObjects
{
    public abstract class CommonMethods
    {
        ...
        internal void ScrollUpWithinElement(Func<AppQuery, AppQuery> ElementToScrollUp)
        {
        ...
        internal void ScrollDownWithinElement(Func<AppQuery, AppQuery> ElementToScrollUp)
        {
            var element = _app.Query(ElementToScrollUp).FirstOrDefault();
