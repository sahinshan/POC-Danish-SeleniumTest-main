...
{
    public class CaseTaskRecordPage : CommonMethods
    {
        ...
        public CaseTaskRecordPage(IApp app)
        {
            _app = app;
        }


        public CaseTaskRecordPage WaitForCaseTaskRecordPageToLoad(string PageTitleText)
        {
        ...
        public CaseTaskRecordPage ValidateSubjectFieldTitleVisible(bool ExpectFieldVisible)
        {
        ...
        public CaseTaskRecordPage ValidateDescriptionFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateResponsibleUserFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateResponsibleTeamFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateDueFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateStatusFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateOutcomeFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateCategoryFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateSubCategoryFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidatePriorityFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateReasonFieldTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateCreatedByTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateCreatedOnTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateModifieddByTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateModifieddOnTitleVisible(bool ExpectFieldVisible)
        {
            if (ExpectFieldVisible)
            {
        ...
        public CaseTaskRecordPage ValidateSubjectFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateDescriptionFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateDescriptionRichFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateResponsibleUserFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateResponsibleTeamFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateResponsibleTeamLookupFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateDueFieldText(string ExpectDateText, string ExpectTimeText)
        {
        ...
        public CaseTaskRecordPage ValidateStatusFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateOutcomeFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateCategoryFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateSubCategoryFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidatePriorityFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateReasonFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateCreatedByFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateCreatedOnFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateModifieddByFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage ValidateModifieddOnFieldText(string ExpectText)
        {
        ...
        public CaseTaskRecordPage InsertSubject(string ValueToInsert)
        {
            ScrollToElement(_subject_Field);
        ...
        public CaseTaskRecordPage InsertDescription(string ValueToInsert)
        {
            ScrollToElement(_description_Field);
        ...
        public CaseTaskRecordPage TapResponsibleTeamRemoveButton()
        {
        ...
        public CaseTaskRecordPage TapResponsibleTeamLookupButton()
        {
        ...
        public CaseTaskRecordPage TapReasonRemoveButton()
        {
        ...
        public CaseTaskRecordPage TapReasonLookupButton()
        {
        ...
        public CaseTaskRecordPage TapPriorityRemoveButton()
        {
        ...
        public CaseTaskRecordPage TapPriorityLookupButton()
        {
        ...
        public CaseTaskRecordPage InsertDueDate(string DateValue, string TimeValue)
        {
            ScrollToElement(_Due_DateField);
        ...
        public CaseTaskRecordPage TapOutcomeRemoveButton()
        {
        ...
        public CaseTaskRecordPage TapOutcomeLookupButton()
        {
        ...
        public CaseTaskRecordPage TapStatusPicklist()
        {
        ...
        public CaseTaskRecordPage TapCategoryRemoveButton()
        {
        ...
        public CaseTaskRecordPage TapCategoryLookupButton()
        {
        ...
        public CaseTaskRecordPage TapSubCategoryRemoveButton()
        {
        ...
        public CaseTaskRecordPage TapSubCategoryLookupButton()
        {
        ...
        public CaseTaskRecordPage ValidateResponsibleTeamRemoveButtonVisible(bool ExpectButtonVisible)
        {
        ...
        public CaseTaskRecordPage ValidateReasonRemoveButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_reason_RemoveButton);
        ...
        public CaseTaskRecordPage ValidatePriorityRemoveButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_priority_RemoveButton);
        ...
        public CaseTaskRecordPage ValidateOutcomeRemoveButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_Outcome_RemoveButton);
        ...
        public CaseTaskRecordPage ValidateCategoryRemoveButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_Category_RemoveButton);
        ...
        public CaseTaskRecordPage ValidateSubCategoryRemoveButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_SubCategory_RemoveButton);
        ...
        public CaseTaskRecordPage ValidateResponsibleTeamLookupButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_ResponsibleTeam_LookupButton);
        ...
        public CaseTaskRecordPage ValidateReasonLookupButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_reason_LookupButton);
        ...
        public CaseTaskRecordPage ValidatePriorityLookupButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_priority_LookupButton);
        ...
        public CaseTaskRecordPage ValidateOutcomeLookupButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_Outcome_LookupButton);
        ...
        public CaseTaskRecordPage ValidateCategoryLookupButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_Category_LookupButton);
        ...
        public CaseTaskRecordPage ValidateSubCategoryLookupButtonVisible(bool ExpectButtonVisible)
        {
            if (ExpectButtonVisible)
            {
                ScrollToElement(_SubCategory_LookupButton);
        ...
        public CaseTaskRecordPage TapOnSaveButton()
        {
            Tap(_saveButton);
        ...
        public CaseTaskRecordPage TapOnSaveAndCloseButton()
        {
        ...
        public CaseTaskRecordPage TapOnDeleteButton()
        {
            Tap(_deleteButton);
        ...
        public CaseTaskRecordPage WaitForSaveButtonNotVisible()
        {
        ...
        public CaseTaskRecordPage WaitOnSaveAndCloseButtonNotVisible()
        {
        ...
        public CaseTaskRecordPage WaitForDeleteButtonNotVisible()
        {
