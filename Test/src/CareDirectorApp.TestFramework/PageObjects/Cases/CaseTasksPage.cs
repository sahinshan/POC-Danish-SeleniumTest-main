...
namespace CareDirectorApp.TestFramework.PageObjects
{
    public class CaseTasksPage : CommonMethods
    {
        ...
        public CaseTasksPage(IApp app)
        {
            _app = app;
        }


        public CaseTasksPage WaitForCaseTasksPageToLoad(string ViewText = "Active Tasks")
        {
        ...
        public CaseTasksPage TapToogleButton(string RecordID)
        {
        ...
        public CaseTasksPage ValidateSubjectFieldValue(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateCreatedOnFieldValue(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateCreatedOnFieldNotVisible(string RecordID)
        {
        ...
        public CaseTasksPage ValidateResponsibleUserFieldValue(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateResponsibleUserFieldNotVisible(string RecordID)
        {
        ...
        public CaseTasksPage ValidateCreatedByFieldValue(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateCreatedByFieldNotVisible(string RecordID)
        {
        ...
        public CaseTasksPage ValidateModifiedByFieldValue(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateModifiedOnFieldValue(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateSubjectCellText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateResponsibleTeamCellText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateDueCellText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateCreatedByCellText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateCreatedOnCellText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateModifiedByText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage ValidateModifiedOnCellText(string ExpectedText, string RecordID)
        {
        ...
        public CaseTasksPage TapOnAddNewRecordButton()
        {
        ...
        public CaseTasksPage TapOnRecord(string recordText)
        {
        ...
        public CaseTasksPage TapOnViewPicker()
        {
        ...
        public CaseTasksPage ValidateNoRecordsMessageVisibility(bool NoRecordsMessageVisible)
        {
