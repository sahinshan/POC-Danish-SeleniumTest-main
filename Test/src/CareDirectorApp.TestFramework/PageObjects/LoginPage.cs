...
namespace CareDirectorApp.TestFramework.PageObjects
{
    public class LoginPage: CommonMethods
    {
        ...
        /// <summary>
        /// This is a generic method that will wait only for the common elements in the login page, that are displayed either if we have a previous login or not.
        /// Use this method to wait for the login page if it is not possible to determine if a previous login happen.
        /// </summary>
        /// <returns></returns>
        ...
        public LoginPage TapOnEnvironentPicklist(String environment)
        {
            _app.Tap(_environmentLabel);
