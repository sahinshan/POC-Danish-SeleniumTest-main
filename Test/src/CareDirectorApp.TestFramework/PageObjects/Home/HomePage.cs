...
namespace CareDirectorApp.TestFramework.PageObjects
{
    public class HomePage : CommonMethods
    {
        ...
        public HomePage WaitForHomePageToLoad()
        {
            ...
            _app.WaitForElement(_backButton, "Unable to find the element: BackImage", _timeoutTimeSpan, _retryFrequency);
            _app.WaitForElement(_homepageLogo, "Unable to find the element: EntityImage", _timeoutTimeSpan, _retryFrequency);
            _app.WaitForElement(_homepageTitle, "Unable to find the element: HOME", _timeoutTimeSpan, _retryFrequency);
