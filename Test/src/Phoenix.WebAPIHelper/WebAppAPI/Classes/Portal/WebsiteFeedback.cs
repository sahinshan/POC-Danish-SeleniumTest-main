...
{
    internal class WebsiteFeedback : IWebsiteFeedback
    {

        string contactsURL = "api/portal/{0}/feedback";
        ...
        public Guid Feedback(Entities.Portal.WebsiteFeedback WebsiteFeedback,  Guid WebsiteID, string SecurityToken)
        {
            ...
            string jsonBody = Newtonsoft.Json.JsonConvert.SerializeObject(WebsiteFeedback);
