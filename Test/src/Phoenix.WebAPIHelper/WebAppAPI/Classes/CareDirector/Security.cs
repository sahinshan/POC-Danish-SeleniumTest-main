...
namespace Phoenix.WebAPIHelper.WebAppAPI.Classes
{
    internal class Security : ISecurity
    {
        ...
        public string Authenticate()
        {
            ...
            string EnvironmentId = System.Configuration.ConfigurationManager.AppSettings.Get("EnvironmentID");
            ...
            request.AddParameter("TenantId", EnvironmentId);
        ...
        public string Authenticate(string TenantName, string UserName, string Password)
        {
            ...
            request.AddParameter("Username", UserName);
            request.AddParameter("Password", Password);
            request.AddParameter("RememberDetails", "False");
