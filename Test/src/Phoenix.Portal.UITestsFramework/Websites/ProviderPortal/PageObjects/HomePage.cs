...
namespace Phoenix.Portal.UITestsFramework.Websites.ProviderPortal.PageObjects
{
    public class HomePage : CommonMethods
    {
        ...
        readonly By footer_PortalLogo = By.XPath("//*[@id='CWFooter']/mosaic-row/mosaic-col[2]/mosaic-img/img[@src='/resources/websitelogo.png']");
        ...
        public HomePage WaitForHomePageToLoad()
        {
            ...
            WaitForElement(footer_ContactUsHeader);
            WaitForElement(footer_ContactUsInformation);

            WaitForElement(footer_PortalLinksHeaders);
            WaitForElement(footer_PortalLogo);
            WaitForElement(footer_PoweredByCareDirector);

            WaitForElement(footer_ConnectWithUsHeader);
            WaitForElement(footer_TwitterIcon);
            WaitForElement(footer_FacebookIcon);
            WaitForElement(footer_InstagramIcon);
            WaitForElement(footer_YoutubeIcon);
