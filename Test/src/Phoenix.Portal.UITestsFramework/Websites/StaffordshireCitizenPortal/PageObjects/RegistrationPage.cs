...
namespace Phoenix.Portal.UITestsFramework.Websites.StaffordshireCitizenPortal.PageObjects
{
    public class RegistrationPage : CommonMethods
    {
        ...
        readonly By pageHeader = By.XPath("//mosaic-page-header/div/div/div/div/h1[text()='Register an account']");
        ...
        readonly By personalDetailsTopMessage = By.XPath("//*[@id='CWSection_PersonalDetails']/mosaic-card-body/div/mosaic-alert/div/p[text()='The details of the person requiring support, if you are filling this in on their behalf']");
        ...
        readonly By contactDetailsTopMessage = By.XPath("//*[@id='CWSection_ContactDetails']/mosaic-card-body/div/mosaic-alert/div/p[text()='The details of the person requiring support, if you are filling this in on their behalf']");
        ...
        readonly By HowToReceivePINFieldMainField = By.XPath("//*[@id='CWTwoFactorAuthenticationType']/div/div/span[@class='placeholder']");
        readonly By HowToReceivePINFieldSearchTextBox = By.XPath("//*[@id='CWTwoFactorAuthenticationType']/div/div/div[@class='ss-search']/input");
        By HowToReceivePINFieldPicklistElement(string ElementText) => By.XPath("//*[@id='CWTwoFactorAuthenticationType']/div/div/div/div[text()='" + ElementText + "']");
        ...
        readonly By MobilePhoneFieldError = By.XPath("//*[@id='CWField_mobilephone']/div[3]/span");
        ...
        {
            SetElementDisplayStyleToInline("CWTwoFactorAuthenticationType", 1);
        ...
        public RegistrationPage SelectHowToReceivePINInMainField(string TextToSelect)
        {
            Click(HowToReceivePINFieldMainField);

            WaitForElementVisible(HowToReceivePINFieldSearchTextBox);
            SendKeys(HowToReceivePINFieldSearchTextBox, TextToSelect);

            WaitForElementToBeClickable(HowToReceivePINFieldPicklistElement(TextToSelect));
            Click(HowToReceivePINFieldPicklistElement(TextToSelect));
        ...
        public RegistrationPage InsertPassword(string TextToInsert)
        {
            ...
            SendKeysWithoutClearing(passwordField, Keys.Tab);
        ...
        {
            WaitForElementToBeClickable(MobilePhoneField);
        ...
        public RegistrationPage ValidatePasswordPromptMinLowerVisible(bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public RegistrationPage ValidatePasswordPromptMinLowerText(string ExpectedText)
        {
        ...
        public RegistrationPage ValidatePasswordPromptMinLowerIconValid(bool ExpectValid)
        {
            if (ExpectValid)
            {
        ...
        public RegistrationPage ValidateErrorMessageVisible()
        {
            WaitForElementVisible(errorMessage);

            return this;
        }
        public RegistrationPage ValidateErrorMessageText(string ExpectedText)
        {
