...
namespace Phoenix.Portal.UITestsFramework.Websites.StaffordshireCitizenPortal.PageObjects
{
    public class MainMenu : CommonMethods
    {
        ...
        readonly By EditTwoFactorAuthenticationButton = By.Id("CWTwoFactorAuthentication");
        ...
        public MainMenu ClickEditTwoFactorAuthenticationButton()
        {
            Click(EditTwoFactorAuthenticationButton);
        ...
        public MainMenu ValidateEditTwoFactorAuthenticationButtonVisible(bool ExpectVisible)
        {
            if (ExpectVisible)
                WaitForElementVisible(EditTwoFactorAuthenticationButton);
            else
                WaitForElementNotVisible(EditTwoFactorAuthenticationButton, 7);
