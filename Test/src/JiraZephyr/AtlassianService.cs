...
namespace JiraZephyr
{
    ...
    public class AtlassianService : IAtlassianService
    {
        ...
        public ZephyrCloudHelper.Models.Jira.Version CreateVersion(string versionName, string projectKey)
        {
            try
            {
                var version = _jiraCloudApi.GetVersion(versionName);
        ...
        public ZephyrCloudHelper.Models.Jira.Version GetReleaseVersion(string versionName) =>
