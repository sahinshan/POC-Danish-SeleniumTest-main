...
namespace CareCloud.UITests.Resedential_Care_Tests
{
    ...
    public class MobilityBOUITests : TestBase
    {
        #region Properties
        ...
        private string _loginUsername = "Mobility_User_1";
        ...
        public void TestInitializationMethod()
        {
            ...
            try
            {
                ...
                _bookingType5 = commonMethodsDB.CreateCPBookingType("MobilityBookingType-005", 5, 960, new TimeSpan(6, 0, 0), new TimeSpan(22, 0, 0), 2, false, 1440);

                #endregion

                #region Provider 1

                _providereId1 = commonMethodsDB.CreateProvider("MobilityProvider-001", _careDirectorQA_TeamId, 13, true); //create a "Residential Establishment" provider
        ...
        [Test]
        [Property("JiraIssueID", "ACC-5263")]
        [Description("Care Cloud Mobile app -Resedential Care -View completed Mobility record in mobile .Step1-Step7")]
        public void MobilityBO_UITestMethod_001()
        {
            ...
            mobilityRecordPage
                ...
                .TapMobilisedFromButton(_carePhysicalLocationFrom.ToString())
                .TapMobilisedToButton(_carePhysicalLocationTo.ToString())
                .InsertApproxiamateDistUnitTextBox("5")
            ...
            mobilityRecordPage
                .WaitForMobilityRecordPageLookupToReLoad(_personFullname, _personnumber)
                .InsertTimeSpent()
                .TapsaveNClose();
            ...
            resedentDetailsPage
                ...
                .validateCareNote(perfonfirstname + " moved from the " + _carePhysicalLocationfrom + " to the " + _carePhysicalLocationto + ", approximately 5 Metres.\n" +
perfonfirstname + " used the following equipment: " + _careEquipment + ".\n" +
perfonfirstname + " came across as " + _carewellbeing + ".\n" +
perfonfirstname + " did not require any assistance.\n" +
...
"Overall, I spent 5 minutes with " + perfonfirstname + ".");
        ...
        [Test]
        [Property("JiraIssueID", "ACC-7434")]
        [Description("Care Cloud Mobile app -Resedential Care -View completed Mobility record in mobile .When the consent form is  absent")]
        public void MobilityBO_UITestMethod_002()
        {
            _providerName = (string)dbHelper.provider.GetProviderByID(_providereId1, "name")["name"];
            _personFullname = (string)dbHelper.person.GetPersonById(_personID, "fullname")["fullname"];
            _personnumber = (int)dbHelper.person.GetPersonById(_personID, "personnumber")["personnumber"];
            ...
            resedentDetailsPage
                ...
                .TapCareConsentAbsent(_personFullname, _personnumber)
                .setCareConsentAbsent(_personFullname, _personnumber, "Absence Test")
                .TapsaveNClose();
            ...
            resedentDetailsPage
                ...
                .VerifyConsentAgreed(mobilerecord.ToString(), "Consent given")
                .VerifyConsentAgreed(mobilerecord.ToString(), _systemUsername)
                .validateCareNote("Absence Test");
        }

        [Test]
        [Property("JiraIssueID", "ACC-7438")]
        [Description("Care Cloud Mobile app -Resedential Care -View completed Mobility record in mobile .When the consent form is declined ")]
        public void MobilityBO_UITestMethod_003()
        {
            _providerName = (string)dbHelper.provider.GetProviderByID(_providereId1, "name")["name"];
            _personFullname = (string)dbHelper.person.GetPersonById(_personID, "fullname")["fullname"];
            _personnumber = (int)dbHelper.person.GetPersonById(_personID, "personnumber")["personnumber"];
            ...
            resedentDetailsPage
                ...
                .TapBO(_personFullname, _personnumber, "Mobility")
                .TapCareConsentgivenNo(_personFullname, _personnumber)
                .TapCareConsentDeclined(_personFullname, _personnumber)
                .setReasonCareConsenDeclined(_personFullname, _personnumber, "Reason consent declined")
                .setEncourageConsentDeclined(_personFullname, _personnumber, "Encourage consent declining")
                .TapsaveNClose();
            ...
            resedentDetailsPage
                ...
                .TapCompletedRecord(mobilerecord.ToString())
                .VerifyConsentAgreed(mobilerecord.ToString(), todayDate.ToString("hh:mm tt"))
                .VerifyConsentAgreed(mobilerecord.ToString(), "Declined")
                .VerifyConsentAgreed(mobilerecord.ToString(), _systemUsername)
                .validateCareDecline("Reason consent declined", "Encourage consent declining");
        }

        [Test]
        [Property("JiraIssueID", "ACC-7450")]
        [Description("Care Cloud Mobile app -Resedential Care -View completed Mobility record in mobile .When the consent form is deferred ")]
        public void MobilityBO_UITestMethod_004()
        {
            _providerName = (string)dbHelper.provider.GetProviderByID(_providereId1, "name")["name"];
            _personFullname = (string)dbHelper.person.GetPersonById(_personID, "fullname")["fullname"];
            _personnumber = (int)dbHelper.person.GetPersonById(_personID, "personnumber")["personnumber"];
