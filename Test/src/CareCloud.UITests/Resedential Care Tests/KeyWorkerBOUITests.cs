...
namespace CareCloud.UITests.Resedential_Care_Tests
{
    ...
    public class KeyWorkerBOUITests : TestBase
    {
        #region Properties
        ...
        private string _loginUsername = "KeyworkerNotes_User";
        ...
        public void TestInitializationMethod()
        {
            ...
            try
            {
                ...
                _providereId1 = commonMethodsDB.CreateProvider("KeyWorkerProvider", _careDirectorQA_TeamId, 13, true); //create a "Residential Establishment" provider
        ...
        [Test]
        [Property("JiraIssueID", "ACC-9000")]
        [Description("Verify the Keyworker Notes care task is added to the mobile using add care button in mobile app.")]
        public void KeyWorkerNotesBO_UITestMethod_001()
        {
            ...
            resedentDetailsPage
                ...
                .TapCareTab()
                .TapAddCareButton()
                .TapBO(_personFullname, _personnumber, "Keyworker Note");

            keyWorkerNotesRecordPage
                .WaitForKeyWorkerNotesRecordPageToLoad(_personFullname, _personnumber)
                .InsertSpecifyOtherConversationTextBox("KeyWorker Text")
                .InsertTimeCareGiven();
            ...
            keyWorkerNotesRecordPage
                .WaitForKeyWorkerNotesRecordPageToReLoad(_personFullname, _personnumber)
                .InsertTimeSpent()
                .TapsaveNClose();
            ...
            resedentDetailsPage
                .WaitForResedentDetailsPageToLoad(_personFullname, _personnumber)
                .VerifyConsentAgreed(_keyworkerNoteId1.ToString(), todayDate.ToString("hh:mm tt"))
                .VerifyConsentAgreed(_keyworkerNoteId1.ToString(), _systemUsername)
                .TapCompletedRecord(_keyworkerNoteId1.ToString())
                .validateCareNote("KeyWorker Text");
