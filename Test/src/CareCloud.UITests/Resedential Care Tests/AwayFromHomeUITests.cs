...
namespace CareCloud.UITests.Resedential_Care_Tests
{
    ...
    public class AwayFromHomeUITests : TestBase
    {
        ...
        private string _loginUsername = "CarePlan_User";
        ...
        public void TestInitializationMethod()
        {
            ...
            try
            {
                ...
                _bookingType5 = commonMethodsDB.CreateCPBookingType("AbsenceBookingType-005", 5, 960, new TimeSpan(6, 0, 0), new TimeSpan(22, 0, 0), 2, false, 1440);
                ...
                _providereId1 = commonMethodsDB.CreateProvider("AbsenceProvider-008", _careDirectorQA_TeamId, 13, true); //create a "Residential Establishment" provider
        ...
        public void AwayFromHome_VerifyAwayFromHome01()
        {
