...
namespace CareCloud.UITests.Resedential_Care_Tests
{
    ...
    public class ContinenceCareBOUITests : TestBase
    {
        #region Properties
        ...
        private string _loginUsername = "ContinenceCare_User";
        ...
        public void TestInitializationMethod()
        {
            ...
            try
            {
                ...
                _bookingType5 = commonMethodsDB.CreateCPBookingType("ContinenceBookingType-005", 5, 960, new TimeSpan(6, 0, 0), new TimeSpan(22, 0, 0), 2, false, 1440);

                #endregion

                #region Provider 1

                _providereId1 = commonMethodsDB.CreateProvider("ContinenceProvider", _careDirectorQA_TeamId, 13, true); //create a "Residential Establishment" provider
                ...
                var _ethnicityId = commonMethodsDB.CreateEthnicity(_careDirectorQA_TeamId,"Irish", DateTime.Now);
        ...
        [Test]
        [Property("JiraIssueID", "ACC-8485")]
        [Description("As a rostered user verify Continence care full record, required fields & sections of full record when consent given is selected in the mobile app")]
        public void ContinenceCareBO_UITestMethod_001()
        {
            ...
            resedentDetailsPage
                ...
                .TapCareTab()
                .TapAddCareButton()
                .TapContinenceCareBO(_personFullname, _personnumber, "Continence Care")
                .TapCareConsentgivenYes(_personFullname, _personnumber);

            continenceCareRecordPage
               .WaitForContinenceCareRecordPageLookupToLoad(_personFullname, _personnumber)
               .VerfiyCatheterRequired()
               .TapCatheterCareNeeded()
               .TapIsCatheterDraining()
               .TapCatheterBagBeenEmptied()
               .TapCatheterBeingPositioned()
               .TapCatheterAreaCleaned()
               .TapThereIsMalodour()
               .TapUrinePassed()
               .SetUrineOutputAmount("1")
               .TapUrineColor("Amber")
               .TapStoolPassed()
               .TapStoolAmount("Small")
               .TapStoolType("Dry lumps")
               .TapBloodIsPresent()
               .TapMucusIsPresent()
               .TapContinencePadBeenChanged("Yes")
               .SelectConcernsWithSkinCondition("Yes")
               .SetWhereonTheBodyTxtArea("Where on the Body")
            ...
            continenceCareRecordPage
              .WaitForContinenceCareRecordPageLookupToReLoad(_personFullname, _personnumber)
            ...
            var mobilerecord = dbHelper.cpPersonToileting.GetByPersonId(_personID).FirstOrDefault();
           ...
           .validateCareNote(perfonfirstname + "'s catheter care was completed as required.\n" +
perfonfirstname + " passed urine that was Amber.\n" +
perfonfirstname + " passed stool that was Type 1 - Separate hard lumps, like nuts (hard to pass).\n" +
"Mucus was present in their stool.\n" +
"Blood was present in their stool.\n" +
"The following new skin concerns were noted on " + perfonfirstname + "'s Where on the Body: Dry Skin.\n" +
perfonfirstname + "'s continence pad was changed.\n" +
...
"We would like to note that: Additional Notes."
        ...
        [Test]
        [Property("JiraIssueID", "ACC-8496")]
        [Description("As a rostered user verify Continence care full record, required fields & sections of full record when consent given is selected in the mobile app")]
        public void ContinenceCareBO_UITestMethod_002()
        {
            _providerName = (string)dbHelper.provider.GetProviderByID(_providereId1, "name")["name"];
            _personFullname = (string)dbHelper.person.GetPersonById(_personID, "fullname")["fullname"];
            _personnumber = (int)dbHelper.person.GetPersonById(_personID, "personnumber")["personnumber"];
            ...
            continenceCareRecordPage
                ...
                .VerfiyCatheterRequired()
                .TapCatheterCareNeeded()
                .VerfiyCatheterPatentAndDraining()
                .VerfiyCatheterBagEmptied()
                .VerfiyCatheterPositioned()
                .VerfiyCatheterAreaCleaned()
                .VerfiyIsThereAnyMalodour()
                .VerfiyPassedUrine()
                .VerfiyBowelsOpened()
                .VerfiyContinencePadChanged()
                .VerfiySkinConditionLabel()
                .SelectConcernsWithSkinCondition("Yes")
                .VerfiySkinConditionFields();
