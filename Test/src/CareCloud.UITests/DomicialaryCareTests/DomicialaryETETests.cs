...
{
    [TestFixture]
    [Category("Mobile_TabletMode_Online"), Category("DomiciliaryCare")]
    public class DomicialaryETETests : TestBase
    {
        #region Properties
        ...
        public void TestInitializationMethod()
        {
            ...
            try
            {
                ...
                var _ethnicityId = commonMethodsDB.CreateEthnicity(_careDirectorQA_TeamId,"Irish", new DateTime(2000, 1, 1));
        ...
        public void DomicialaryCareTest_001()
        {
            MainMenu
               .NavigateToHomePage();
        ...
        public void DomicialaryCareTest_002()
        {
            MainMenu
               .NavigateToHomePage();
        ...
        public void DomicialaryCareTest_003()
        {
            MainMenu
               .NavigateToHomePage();
        ...
        [Test]
        [Property("JiraIssueID", "ACC-6301")]
        [Description("Care Cloud Mobile app -Domiciliary Care -Regression test case for end to end functionality in online mode " +
                     ".Step7*Add daily care items , update and delete")]
        public void DomicialaryCareTest_004()
        {
        ...
        [Test]
        [Property("JiraIssueID", "ACC-6302")]
        [Description("Care Cloud Mobile app -Domiciliary Care -Regression test case for end to end functionality in online mode " +
                     ".Step7*Enter data in Problems and notes & verify in web app")]
        public void DomicialaryCareTest_005()
        {
