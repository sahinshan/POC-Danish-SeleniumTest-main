...
namespace CareCloud.UITests.LoginPage
{
    ...
    public class Domicialary_OnlineTests : TestBase
    {
        #region Properties
        ...
        [Test]
        [Property("JiraIssueID", "ACC-8461")]
        [Description("As a rostered user Verify Contact functionality on both Booking Details and Visit Details screen in online mode")]
        public void DomicialaryCareTest_VerifyContactDetails()
        {
            MainMenu
               .NavigateToHomePage();
