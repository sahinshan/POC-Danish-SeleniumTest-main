...
{
    public class Sectio117EntitlementCaseNoteRecordPage : CommonMethods
    {

        public Sectio117EntitlementCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=mhaaftercareentitlementcasenote')]");
        ...
        public Sectio117EntitlementCaseNoteRecordPage WaitForSectio117EntitlementCaseNoteRecordPageToLoad()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ClickBackButton()
        {
        ...
        public Sectio117EntitlementCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
