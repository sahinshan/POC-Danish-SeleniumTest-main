...
{
    public class CaseFormAppointmentRecordPage : CommonMethods
    {

        public CaseFormAppointmentRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        public CaseFormAppointmentRecordPage WaitForCaseFormAppointmentRecordPageToLoad(string AppointmentTitle)
        {
        ...
        public CaseFormAppointmentRecordPage ValidateNotificationMessageVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public CaseFormAppointmentRecordPage ValidateNotificationMessageText(string ExpectText)
        {
        ...
        public CaseFormAppointmentRecordPage ValidateSubject(string ExpectedText)
        {
            ValidateElementValue(Subject_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateRequired(string attendeeID, string ExpectedText)
        {
            ValidateElementText(Required_Field(attendeeID), ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateOptional(string attendeeID, string ExpectedText)
        {
            ValidateElementText(Optional_Field(attendeeID), ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateMeetingNotes(string ExpectedText)
        {
        ...
        public CaseFormAppointmentRecordPage ValidateStartDate(string ExpectedText)
        {
            ValidateElementValue(StartDate_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateEndDate(string ExpectedText)
        {
            ValidateElementValue(EndDate_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateShowTimeAs(string ExpectedText)
        {
            ValidatePicklistSelectedText(ShowTimeAs_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateStartTime(string ExpectedText)
        {
            ValidateElementValue(StartTime_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateEndTime(string ExpectedText)
        {
            ValidateElementValue(EndTime_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateAllowConcurrentAppointmentCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormAppointmentRecordPage ValidateRegardingFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Regarding_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateAppointmentTypeFieldLinkText(string ExpectedText)
        {
            ValidateElementText(AppointmentType_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateLocation(string ExpectedText)
        {
            ValidateElementText(Location_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidatePriorityFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Priority_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateResponsibleTeamFieldLinkText(string ExpectedText)
        {
            ValidateElementText(ResponsibleTeam_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateResponsibleUserFieldLinkText(string ExpectedText)
        {
            ValidateElementText(ResponsibleUser_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateIsCaseNoteCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormAppointmentRecordPage ValidateCategoryFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Category_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateSubCategoryFieldLinkText(string ExpectedText)
        {
            ValidateElementText(SubCategory_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateReasonFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Reason_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateOutcomeFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Outcome_LinkField, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateStatus(string ExpectedText)
        {
            ValidatePicklistSelectedText(Status_Field, ExpectedText);

            return this;
        }
        public CaseFormAppointmentRecordPage ValidateContainsInformationProvidedByAThirdPartyCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormAppointmentRecordPage ValidateSignificantEventCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormAppointmentRecordPage InsertSubject(string Subject)
        {
            SendKeys(Subject_Field, Subject);
            
            return this;
        }
        public CaseFormAppointmentRecordPage InsertDescription(string Subject)
        {
            SetElementDisplayStyleToInline("CWField_notes");
            SetElementVisibilityStyleToVisible("CWField_notes");
        ...
        public CaseFormAppointmentRecordPage InsertStartDate(string Date)
        {
        ...
        public CaseFormAppointmentRecordPage SelectStatus(string TextToSelect)
        {
        ...
        public CaseFormAppointmentRecordPage ClickRegardingLookupButton()
        {
            Click(Regarding_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickReasonLookupButton()
        {
            Click(Reason_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickPriorityLookupButton()
        {
            Click(Priority_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickResponsibleTeamLookupButton()
        {
            Click(ResponsibleTeam_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickResponsibleUserLookupButton()
        {
            Click(ResponsibleUser_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickCategoryLookupButton()
        {
            Click(Category_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickSubCategoryLookupButton()
        {
            Click(SubCategory_LookupButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickOutcomeLookupButton()
        {
        ...
        public CaseFormAppointmentRecordPage ClickContainsInformationProvidedByAThirdParty_YesRadioButton()
        {
            Click(ContainsInformationProvidedByAThirdParty_YesRadioButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickContainsInformationProvidedByAThirdParty_NoRadioButton()
        {
            Click(ContainsInformationProvidedByAThirdParty_NoRadioButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickSignificantEvent_YesRadioButton()
        {
            Click(SignificantEvent_YesRadioButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickSignificantEvent_NoRadioButton()
        {
        ...
        public CaseFormAppointmentRecordPage ClickBackButton()
        {
        ...
        public CaseFormAppointmentRecordPage ClickSaveButton()
        {
        ...
        public CaseFormAppointmentRecordPage ClickSaveAndCloseButton()
        {
            this.Click(saveAndCloseButton);

            return this;
        }
        public CaseFormAppointmentRecordPage ClickSaveAndCloseButtonAndWaitForNoRefreshPannel()
        {
            this.Click(saveAndCloseButton);
        ...
        public CaseFormAppointmentRecordPage ClickDeleteButton()
        {
