...
namespace Phoenix.UITests.Framework.PageObjects
{
    public class CaseCaseNoteRecordPage : CommonMethods
    {
        ...
        public CaseCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=casecasenote')]");
        ...
        public CaseCaseNoteRecordPage WaitForCaseCaseNoteRecordPageToLoad()
        {
        ...
        public CaseCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public CaseCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public CaseCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public CaseCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public CaseCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public CaseCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public CaseCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public CaseCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public CaseCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public CaseCaseNoteRecordPage ClickBackButton()
        {
        ...
        public CaseCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
