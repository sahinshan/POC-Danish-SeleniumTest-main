...
namespace Phoenix.UITests.Framework.PageObjects
{
    public class HealthAppointmentCaseNoteRecordPage : CommonMethods
    {
        ...
        public HealthAppointmentCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=healthappointmentcasenote')]");
        ...
        public HealthAppointmentCaseNoteRecordPage WaitForHealthAppointmentCaseNoteRecordPageToLoad()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if(ExpectVisible)
            {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ClickBackButton()
        {
        ...
        public HealthAppointmentCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
