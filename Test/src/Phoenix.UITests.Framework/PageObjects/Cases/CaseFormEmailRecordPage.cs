...
{
    public class CaseFormEmailRecordPage : CommonMethods
    {

        public CaseFormEmailRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        public CaseFormEmailRecordPage WaitForCaseFormEmailRecordPageToLoad(string EmailTitle)
        {
        ...
        public CaseFormEmailRecordPage ValidateNotificationMessageVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public CaseFormEmailRecordPage ValidateNotificationMessageText(string ExpectText)
        {
        ...
        public CaseFormEmailRecordPage ValidateSubject(string ExpectedText)
        {
            ValidateElementValue(Subject_Field, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateFrom(string ExpectedText)
        {
            ValidateElementText(From_Field, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateTo(string attendeeID, string ExpectedText)
        {
            ValidateElementText(To_Field(attendeeID), ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateDescription(string ExpectedText)
        {
        ...
        public CaseFormEmailRecordPage ValidateRegardingFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Regarding_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateReasonFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Reason_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidatePriorityFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Priority_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateDue(string ExpectedDate, string ExpectedTime)
        {
        ...
        public CaseFormEmailRecordPage ValidateOutcomeFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Outcome_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateContainsInformationProvidedByAThirdPartyCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormEmailRecordPage ValidateIsCaseNoteCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormEmailRecordPage ValidateResponsibleTeamFieldLinkText(string ExpectedText)
        {
            ValidateElementText(ResponsibleTeam_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateResponsibleUserFieldLinkText(string ExpectedText)
        {
            ValidateElementText(ResponsibleUser_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateCategoryFieldLinkText(string ExpectedText)
        {
            ValidateElementText(Category_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateSubCategoryFieldLinkText(string ExpectedText)
        {
            ValidateElementText(SubCategory_LinkField, ExpectedText);

            return this;
        }
        public CaseFormEmailRecordPage ValidateStatus(string ExpectedText)
        {
        ...
        public CaseFormEmailRecordPage ValidateSignificantEventCheckedOption(bool YesOptionChecked)
        {
            if (YesOptionChecked)
            {
        ...
        public CaseFormEmailRecordPage InsertSubject(string Subject)
        {
            SendKeys(Subject_Field, Subject);
            
            return this;
        }
        public CaseFormEmailRecordPage InsertDescription(string Subject)
        {
            SetElementDisplayStyleToInline("CWField_notes");
            SetElementVisibilityStyleToVisible("CWField_notes");
        ...
        public CaseFormEmailRecordPage InsertDue(string Date, string Time)
        {
        ...
        public CaseFormEmailRecordPage SelectStatus(string TextToSelect)
        {
        ...
        public CaseFormEmailRecordPage ClickRegardingLookupButton()
        {
            Click(Regarding_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickReasonLookupButton()
        {
            Click(Reason_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickPriorityLookupButton()
        {
            Click(Priority_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickResponsibleTeamLookupButton()
        {
            Click(ResponsibleTeam_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickResponsibleUserLookupButton()
        {
            Click(ResponsibleUser_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickCategoryLookupButton()
        {
            Click(Category_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickSubCategoryLookupButton()
        {
            Click(SubCategory_LookupButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickOutcomeLookupButton()
        {
        ...
        public CaseFormEmailRecordPage ClickContainsInformationProvidedByAThirdParty_YesRadioButton()
        {
            Click(ContainsInformationProvidedByAThirdParty_YesRadioButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickContainsInformationProvidedByAThirdParty_NoRadioButton()
        {
            Click(ContainsInformationProvidedByAThirdParty_NoRadioButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickSignificantEvent_YesRadioButton()
        {
            Click(SignificantEvent_YesRadioButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickSignificantEvent_NoRadioButton()
        {
        ...
        public CaseFormEmailRecordPage ClickBackButton()
        {
        ...
        public CaseFormEmailRecordPage ClickSaveButton()
        {
        ...
        public CaseFormEmailRecordPage ClickSaveAndCloseButton()
        {
            this.Click(saveAndCloseButton);

            return this;
        }
        public CaseFormEmailRecordPage ClickSaveAndCloseButtonAndWaitForNoRefreshPannel()
        {
            this.Click(saveAndCloseButton);
        ...
        public CaseFormEmailRecordPage ClickDeleteButton()
        {
