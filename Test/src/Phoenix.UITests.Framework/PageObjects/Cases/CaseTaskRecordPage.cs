...
namespace Phoenix.UITests.Framework.PageObjects
{
    public class CaseTaskRecordPage : CommonMethods
    {
        ...
        public CaseTaskRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        public CaseTaskRecordPage WaitForCaseTaskRecordPageToLoad(string CaseNoteTitle)
        {
        ...
        public CaseTaskRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public CaseTaskRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public CaseTaskRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public CaseTaskRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public CaseTaskRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public CaseTaskRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public CaseTaskRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public CaseTaskRecordPage ClickSaveAndCloseButton()
        {
        ...
        public CaseTaskRecordPage ClickCloneButton()
        {
        ...
        public CaseTaskRecordPage ClickBackButton()
        {
        ...
        public CaseTaskRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
