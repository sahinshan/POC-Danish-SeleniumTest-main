...
{
    public class InpatientLeaveAwolAttachmentsRecordPage : CommonMethods
    {

        public InpatientLeaveAwolAttachmentsRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=inpatientleaveawolattachment')]");
        ...
        public InpatientLeaveAwolAttachmentsRecordPage WaitForInpatientLeaveAwolAttachmentsRecordPageToLoad()
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage InsertTitle(string TextToInsert)
        {
            SendKeys(title_Field, TextToInsert);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage InsertDate(string DateToInsert, string TimeToInsert)
        {
            WaitForElementToBeClickable(Date_DateField);
            MoveToElementInPage(Date_DateField);
        ...
        public InpatientLeaveAwolAttachmentsRecordPage UploadFile(string FilePath)
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ClickFileUpdateButton()
        {
            Click(fileUpdate_Field);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickFileUploadButton()
        {
            Click(fileUpload_Field);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickFileLinkField()
        {
            Click(fileLink_Field);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickDocumentTypeLookupButton()
        {
            Click(documentType_LookupButton);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickDocumentTypeRemoveButton()
        {
            Click(documentType_RemoveButton);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickDocumentSubTypeLookupButton()
        {
            Click(documentSubType_LookupButton);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickDocumentSubTypeRemoveButton()
        {
            Click(documentSubType_RemoveButton);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickResponsibleTeamLookupButton()
        {
            Click(ResponsibleTeam_LookupButton);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ClickResponsibleTeamRemoveButton()
        {
            Click(ResponsibleTeam_RemoveButton);

            return this;
        }        
        public InpatientLeaveAwolAttachmentsRecordPage ClickSaveButton()
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ClickSaveAndCloseButton()
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ClickDeleteButton()
        {
            WaitForElementNotVisible("CWRefreshPanel", 7);
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ClickCloneButton()
        {
            WaitForElementToBeClickable(additionalItemsButton);
            Click(additionalItemsButton);
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ClickBackButton()
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ValidateTitle(string ExpectedText)
        {
            ValidateElementValue(title_Field, ExpectedText);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ValidateDate(string ExpectedDate, string ExpectedTime)
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ValidateBrokerageOfferLinkFieldText(string ExpectedText)
        {
            ValidateElementText(BrokerageOffer_LinkField, ExpectedText);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ValidateDocumentTypeLinkFieldText(string ExpectedText)
        {
            ValidateElementText(documentType_LinkField, ExpectedText);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ValidateDocumentSubTypeLinkFieldText(string ExpectedText)
        {
            ValidateElementText(documentSubType_LinkField, ExpectedText);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
            ValidateElementText(ResponsibleTeam_LinkField, ExpectedText);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ValidateFileLinkFieldText(string ExpectedText)
        {
            ValidateElementText(fileLink_Field, ExpectedText);

            return this;
        }
        public InpatientLeaveAwolAttachmentsRecordPage ValidateClonedFromLinkFieldText(string ExpectedText)
        {
        ...
        public InpatientLeaveAwolAttachmentsRecordPage ValidateIsClonedChecked(bool ExpectYes)
        {
            if(ExpectYes)
            {
