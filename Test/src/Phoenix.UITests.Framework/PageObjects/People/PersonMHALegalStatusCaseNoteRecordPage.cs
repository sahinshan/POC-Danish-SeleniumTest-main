...
{
    public class PersonMHALegalStatusCaseNoteRecordPage : CommonMethods
    {

        public PersonMHALegalStatusCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=personmhalegalstatuscasenote')]");
        ...
        public PersonMHALegalStatusCaseNoteRecordPage WaitForPersonMHALegalStatusCaseNoteRecordPageToLoad()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ClickBackButton()
        {
        ...
        public PersonMHALegalStatusCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
