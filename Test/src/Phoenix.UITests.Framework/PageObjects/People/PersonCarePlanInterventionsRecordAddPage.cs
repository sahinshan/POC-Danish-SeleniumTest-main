...
{
    public class PersonCarePlanInterventionRecordAddPage : CommonMethods
    {
        public PersonCarePlanInterventionRecordAddPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By personCarePlanInterventionRecordAddIFrame = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=personcareplanintervention&')]");
        ...
        readonly By WhatDescription_Field = By.Id("CWField_description");
        ...
        readonly By DomainOfNeed_TextFld = By.XPath("//input[@id='CWField_careplanneeddomainid']");
        ...
        public PersonCarePlanInterventionRecordAddPage WaitForPersonCarePlanInterventionRecordAddPageToLoad()
        {
            ...
            WaitForElement(personCarePlanInterventionRecordAddIFrame);
            SwitchToIframe(personCarePlanInterventionRecordAddIFrame);
        ...
        public PersonCarePlanInterventionRecordAddPage InsertWhatDescription(string Description)
        {
            WaitForElementToBeClickable(WhatDescription_Field);
            SendKeys(WhatDescription_Field, Description);
            return this;
        }

        public PersonCarePlanInterventionRecordAddPage TapInterventionTypeLookUpButton()
        {
        ...
        public PersonCarePlanInterventionRecordAddPage TapGoalOutcomeTypeLookUpButton()
        {
        ...
        public PersonCarePlanInterventionRecordAddPage TapResonsibleUserLookUpButton()
        {
        ...
        public PersonCarePlanInterventionRecordAddPage TapDomainOfNeedLookUpButton()
        {
        ...
        public PersonCarePlanInterventionRecordAddPage TapSaveNCloseButton()
        {
        ...
        public PersonCarePlanInterventionRecordAddPage TapInterventionsLink()
        {
        ...
        public PersonCarePlanInterventionRecordAddPage ValidateDomainOfNeedText(String ExpectedText)
        {
            ValidateElementText(DomainOfNeed_TextFld, ExpectedText);
