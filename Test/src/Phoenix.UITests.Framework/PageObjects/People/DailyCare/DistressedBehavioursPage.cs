...
{
    public class DistressedBehavioursPage : CommonMethods
    {
        public DistressedBehavioursPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By pageHeader = By.XPath("//*[@id='CWToolbar']/div/h1[text()='Distressed Behaviours']");
        ...
        public DistressedBehavioursPage WaitForPageToLoad()
        {
        ...
        public DistressedBehavioursPage ClickNewRecordButton()
        {
        ...
        public DistressedBehavioursPage ValidateNoRecordMessageVisibile(bool ExpectedVisible)
        {
            if (ExpectedVisible)
        ...
        public DistressedBehavioursPage ValidateRecordCellText(string RecordID, int CellPosition, string ExpectedText)
        {
        ...
        public DistressedBehavioursPage ValidateRecordCellText(Guid RecordID, int CellPosition, string ExpectedText)
        {
            return ValidateRecordCellText(RecordID.ToString(), CellPosition, ExpectedText);
        }

        public DistressedBehavioursPage SelectView(string TextToSelect)
        {
        ...
        public DistressedBehavioursPage SelectRecord(string RecordId)
        {
        ...
        public DistressedBehavioursPage ValidateRecordPresent(string RecordId, bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public DistressedBehavioursPage ValidateRecordPresent(Guid RecordId, bool ExpectVisible)
        {
            return ValidateRecordPresent(RecordId.ToString(), ExpectVisible);
        }

        public DistressedBehavioursPage ValidateRecordPosition(int ElementPosition, string RecordID)
        {
        ...
        public DistressedBehavioursPage SearchRecord(string SearchQuery)
        {
        ...
        public DistressedBehavioursPage ClickRefreshButton()
        {
        ...
        public DistressedBehavioursPage ClickAssignButton()
        {
        ...
        public DistressedBehavioursPage OpenRecord(string RecordID)
        {
        ...
        public DistressedBehavioursPage OpenRecord(Guid RecordID)
        {
            return OpenRecord(RecordID.ToString());
        }

        public DistressedBehavioursPage ValidateHeaderCellText(int cellPosition, string ExpectedText)
        {
        ...
        public DistressedBehavioursPage ValidateHeaderCellIsDisplayed(string ExpectedText, bool ExpectedVisible = true)
        {
            if (ExpectedVisible)
