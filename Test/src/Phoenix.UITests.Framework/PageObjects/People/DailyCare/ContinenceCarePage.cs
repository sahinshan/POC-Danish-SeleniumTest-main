...
{
    public class ContinenceCarePage : CommonMethods
    {
        public ContinenceCarePage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By pageHeader = By.XPath("//*[@id='CWToolbar']/div/h1[text()='Continence Care']");
        ...
        public ContinenceCarePage WaitForPageToLoad()
        {
        ...
        public ContinenceCarePage ClickNewRecordButton()
        {
        ...
        public ContinenceCarePage ValidateNoRecordMessageVisibile(bool ExpectedVisible)
        {
            if (ExpectedVisible)
        ...
        public ContinenceCarePage ValidateRecordCellText(string RecordID, int CellPosition, string ExpectedText)
        {
        ...
        public ContinenceCarePage ValidateRecordCellText(Guid RecordID, int CellPosition, string ExpectedText)
        {
            return ValidateRecordCellText(RecordID.ToString(), CellPosition, ExpectedText);
        }

        public ContinenceCarePage SelectView(string TextToSelect)
        {
        ...
        public ContinenceCarePage SelectRecord(string RecordId)
        {
        ...
        public ContinenceCarePage ValidateRecordPresent(string RecordId, bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public ContinenceCarePage ValidateRecordPresent(Guid RecordId, bool ExpectVisible)
        {
            return ValidateRecordPresent(RecordId.ToString(), ExpectVisible);
        }

        public ContinenceCarePage ValidateRecordPosition(int ElementPosition, string RecordID)
        {
        ...
        public ContinenceCarePage SearchRecord(string SearchQuery)
        {
        ...
        public ContinenceCarePage ClickRefreshButton()
        {
        ...
        public ContinenceCarePage ClickAssignButton()
        {
        ...
        public ContinenceCarePage OpenRecord(string RecordID)
        {
        ...
        public ContinenceCarePage OpenRecord(Guid RecordID)
        {
            return OpenRecord(RecordID.ToString());
        }

        public ContinenceCarePage ValidateHeaderCellText(int cellPosition, string ExpectedText)
        {
