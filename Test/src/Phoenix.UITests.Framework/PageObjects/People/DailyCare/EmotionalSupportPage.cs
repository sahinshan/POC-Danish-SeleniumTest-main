...
{
    public class EmotionalSupportPage : CommonMethods
    {
        public EmotionalSupportPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By pageHeader = By.XPath("//*[@id='CWToolbar']/div/h1[text()='Emotional Support']");
        ...
        public EmotionalSupportPage WaitForPageToLoad()
        {
        ...
        public EmotionalSupportPage ClickNewRecordButton()
        {
        ...
        public EmotionalSupportPage ValidateNoRecordMessageVisibile(bool ExpectedVisible)
        {
            if (ExpectedVisible)
        ...
        public EmotionalSupportPage ValidateRecordCellText(string RecordID, int CellPosition, string ExpectedText)
        {
        ...
        public EmotionalSupportPage ValidateRecordCellText(Guid RecordID, int CellPosition, string ExpectedText)
        {
            return ValidateRecordCellText(RecordID.ToString(), CellPosition, ExpectedText);
        }

        public EmotionalSupportPage SelectView(string TextToSelect)
        {
        ...
        public EmotionalSupportPage SelectRecord(string RecordId)
        {
        ...
        public EmotionalSupportPage ValidateRecordPresent(string RecordId, bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public EmotionalSupportPage ValidateRecordPresent(Guid RecordId, bool ExpectVisible)
        {
            return ValidateRecordPresent(RecordId.ToString(), ExpectVisible);
        }

        public EmotionalSupportPage ValidateRecordPosition(int ElementPosition, string RecordID)
        {
        ...
        public EmotionalSupportPage SearchRecord(string SearchQuery)
        {
        ...
        public EmotionalSupportPage ClickRefreshButton()
        {
        ...
        public EmotionalSupportPage ClickAssignButton()
        {
        ...
        public EmotionalSupportPage OpenRecord(string RecordID)
        {
        ...
        public EmotionalSupportPage OpenRecord(Guid RecordID)
        {
            return OpenRecord(RecordID.ToString());
        }

        public EmotionalSupportPage ValidateHeaderCellText(int cellPosition, string ExpectedText)
        {
