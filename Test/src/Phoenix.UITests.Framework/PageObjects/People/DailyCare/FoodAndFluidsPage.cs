...
{
    public class FoodAndFluidPage : CommonMethods
    {
        public FoodAndFluidPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By pageHeader = By.XPath("//*[@id='CWToolbar']/div/h1[text()='Food And Fluid']");
        ...
        public FoodAndFluidPage WaitForPageToLoad()
        {
        ...
        public FoodAndFluidPage ClickNewRecordButton()
        {
        ...
        public FoodAndFluidPage ValidateNoRecordMessageVisibile(bool ExpectedVisible)
        {
            if (ExpectedVisible)
        ...
        public FoodAndFluidPage ValidateRecordCellText(string RecordID, int CellPosition, string ExpectedText)
        {
        ...
        public FoodAndFluidPage ValidateRecordCellText(Guid RecordID, int CellPosition, string ExpectedText)
        {
            return ValidateRecordCellText(RecordID.ToString(), CellPosition, ExpectedText);
        }

        public FoodAndFluidPage SelectView(string TextToSelect)
        {
        ...
        public FoodAndFluidPage SelectRecord(string RecordId)
        {
        ...
        public FoodAndFluidPage ValidateRecordPresent(string RecordId, bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public FoodAndFluidPage ValidateRecordPresent(Guid RecordId, bool ExpectVisible)
        {
            return ValidateRecordPresent(RecordId.ToString(), ExpectVisible);
        }

        public FoodAndFluidPage ValidateRecordPosition(int ElementPosition, string RecordID)
        {
        ...
        public FoodAndFluidPage SearchRecord(string SearchQuery)
        {
        ...
        public FoodAndFluidPage ClickRefreshButton()
        {
        ...
        public FoodAndFluidPage ClickAssignButton()
        {
        ...
        public FoodAndFluidPage OpenRecord(string RecordID)
        {
        ...
        public FoodAndFluidPage OpenRecord(Guid RecordID)
        {
            return OpenRecord(RecordID.ToString());
        }

        public FoodAndFluidPage ValidateHeaderCellText(int cellPosition, string ExpectedText)
        {
