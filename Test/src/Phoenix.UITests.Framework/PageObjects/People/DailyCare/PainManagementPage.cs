...
{
    public class PainManagementPage : CommonMethods
    {
        public PainManagementPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By pageHeader = By.XPath("//*[@id='CWToolbar']/div/h1[text()='Pain Management']");
        ...
        public PainManagementPage WaitForPageToLoad()
        {
        ...
        public PainManagementPage ClickNewRecordButton()
        {
        ...
        public PainManagementPage ValidateNoRecordMessageVisibile(bool ExpectedVisible)
        {
            if (ExpectedVisible)
        ...
        public PainManagementPage ValidateRecordCellText(string RecordID, int CellPosition, string ExpectedText)
        {
        ...
        public PainManagementPage ValidateRecordCellText(Guid RecordID, int CellPosition, string ExpectedText)
        {
            return ValidateRecordCellText(RecordID.ToString(), CellPosition, ExpectedText);
        }

        public PainManagementPage SelectView(string TextToSelect)
        {
        ...
        public PainManagementPage SelectRecord(string RecordId)
        {
        ...
        public PainManagementPage ValidateRecordPresent(string RecordId, bool ExpectVisible)
        {
            if (ExpectVisible)
        ...
        public PainManagementPage ValidateRecordPresent(Guid RecordId, bool ExpectVisible)
        {
            return ValidateRecordPresent(RecordId.ToString(), ExpectVisible);
        }

        public PainManagementPage ValidateRecordPosition(int ElementPosition, string RecordID)
        {
        ...
        public PainManagementPage SearchRecord(string SearchQuery)
        {
        ...
        public PainManagementPage ClickRefreshButton()
        {
        ...
        public PainManagementPage ClickAssignButton()
        {
        ...
        public PainManagementPage OpenRecord(string RecordID)
        {
        ...
        public PainManagementPage OpenRecord(Guid RecordID)
        {
            return OpenRecord(RecordID.ToString());
        }

        public PainManagementPage ValidateHeaderCellText(int cellPosition, string ExpectedText)
        {
