...
{
    public class PersonContactCaseNoteRecordPage : CommonMethods
    {

        public PersonContactCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=contactcasenote')]");
        ...
        public PersonContactCaseNoteRecordPage WaitForPersonContactCaseNoteRecordPageToLoad()
        {
        ...
        public PersonContactCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public PersonContactCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public PersonContactCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public PersonContactCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ClickBackButton()
        {
        ...
        public PersonContactCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
