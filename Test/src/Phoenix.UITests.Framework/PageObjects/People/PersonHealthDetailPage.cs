...
namespace Phoenix.UITests.Framework.PageObjects
{
    public class PersonClinicalRiskFactorHistoryPage : CommonMethods
    {
        ...
        readonly By CWNavItem_PersonClinicalRiskFactorHistoryFrame = By.Id("CWNavItem_PersonClinicalRiskFactorHistoryFrame");
        ...
        public PersonClinicalRiskFactorHistoryPage WaitForPersonClinicalRiskFactorHistoryPageToLoad()
        {
            ...
            ValidateElementText(recordsAreaHeaderCell(6), "Responsible Team".ToUpper());
            ScrollToElement(recordsAreaHeaderCell(7));
            ValidateElementText(recordsAreaHeaderCell(7), "End Date".ToUpper());
            ScrollToElement(recordsAreaHeaderCell(8));
            ValidateElementText(recordsAreaHeaderCell(8), "Modified On".ToUpper());
            ScrollToElement(recordsAreaHeaderCell(9));
            ValidateElementText(recordsAreaHeaderCell(9), "Modified By".ToUpper());
            ScrollToElement(recordsAreaHeaderCell(10));
            ValidateElementText(recordsAreaHeaderCell(10), "Created On".ToUpper());
            ScrollToElement(recordsAreaHeaderCell(11));
            ValidateElementText(recordsAreaHeaderCell(11), "Created By".ToUpper());
