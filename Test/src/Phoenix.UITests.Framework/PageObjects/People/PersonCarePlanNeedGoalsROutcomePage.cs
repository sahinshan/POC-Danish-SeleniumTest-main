...
{
    public class PersonCarePlanNeedGoalsROutcomePage : CommonMethods
    {
        public PersonCarePlanNeedGoalsROutcomePage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By personCarePlanNeedIFrame = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=personcareplanneed&')]");
        readonly By personCarePlanNeedGoalROutcomeIFrame = By.Id("CWUrlPanel_IFrame");
        #endregion
        ...
        readonly By DomainOfNeedHeader = By.XPath("//tr[@id='CWGridHeaderRow']/th[5]/a/span[text()='Domain of Need']");
       
        By DomainOfNeedCell(string RecordID) => By.XPath("//*[@id='" + RecordID + "']/td[5]");
        ...
        public PersonCarePlanNeedGoalsROutcomePage WaitForPersonCarePlanNeedGoalROutcomePageToLoad()
        {
            ...
            WaitForElement(personCarePlanNeedIFrame);
            SwitchToIframe(personCarePlanNeedIFrame);

            WaitForElement(personCarePlanNeedGoalROutcomeIFrame);
            SwitchToIframe(personCarePlanNeedGoalROutcomeIFrame);
        ...
        public PersonCarePlanNeedGoalsROutcomePage TapGoalROutcomeLink()
        {
            WaitForElementToBeClickable(GoalsROutcome_Link);
            Click(GoalsROutcome_Link);

            return this;
        }


        public PersonCarePlanNeedGoalsROutcomePage TapCreateRecordButton()
        {
        ...
        public PersonCarePlanNeedGoalsROutcomePage ClickOnCarePlanGoalROutcomeRecord(string RecordID)
        {
        ...
        public PersonCarePlanNeedGoalsROutcomePage ValidateDomainOfNeedHeaderText(string ExpectedText)
        {
        ...
        public PersonCarePlanNeedGoalsROutcomePage ValidateDomainOfNeedCellText(string recordID, string ExpectedText)
        {
