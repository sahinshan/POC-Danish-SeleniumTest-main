...
{
    public class PersonCarePlanFormInitialAssessmentRecordPage : CommonMethods
    {
        public PersonCarePlanFormInitialAssessmentRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By InitialAssessment_YesRadioButton = By.XPath("//input[@id='CW-DQ-33726']");
        readonly By EasilyMakeMyselfUnderstood_NewCareNeedButton = By.XPath("//button[@id='CW-DQ-33726_NewCareNeedButton']");
        ...
        readonly By NewCareNeedSaveNCloseButton = By.Id("TI_CWAssessmentSaveAndCloseButton");
        ...
        By LabelText(string LabelText) => By.XPath("//div[contains(@id,'CWInnerSection_')]//li/label[contains(text(),'" + LabelText + "')]");
        ...
        public PersonCarePlanFormInitialAssessmentRecordPage WaitForPersonCarePlanIFormPageToLoad()
        {
        ...
        public PersonCarePlanFormInitialAssessmentRecordPage WaitForPersonCarePlanInitialAssessmentRecordPageToLoad()
        {
            SwitchToDefaultFrame();
            WaitForElement(contentIFrame);
            SwitchToIframe(contentIFrame);
        ...
        public PersonCarePlanFormInitialAssessmentRecordPage TapYes_EasilyMakeMyselfUnderstoodRadioBtn()
        {
            WaitForElementToBeClickable(InitialAssessment_YesRadioButton);
            Click(InitialAssessment_YesRadioButton);

            return this;
        }

        public PersonCarePlanFormInitialAssessmentRecordPage TapNewCareNeedBtn()
        {
            WaitForElementToBeClickable(EasilyMakeMyselfUnderstood_NewCareNeedButton);
            Click(EasilyMakeMyselfUnderstood_NewCareNeedButton);

            return this;
        }


        public PersonCarePlanFormInitialAssessmentRecordPage TapSavenCloseBtn()
        {
            WaitForElementToBeClickable(NewCareNeedSaveNCloseButton);
            Click(NewCareNeedSaveNCloseButton);

            return this;
        }
        public PersonCarePlanFormInitialAssessmentRecordPage ValidateFormLabel(string ExpectedText, String text)
        {
            WaitForElement(LabelText(text));
            ValidateElementText(LabelText(text), ExpectedText);
