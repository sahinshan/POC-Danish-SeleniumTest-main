...
{
    public class PersonHeightAndWeightCaseNoteRecordPage : CommonMethods
    {

        public PersonHeightAndWeightCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=personheightandweightcasenote')]");
        ...
        public PersonHeightAndWeightCaseNoteRecordPage WaitForPersonHeightAndWeightCaseNoteRecordPageToLoad()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ClickBackButton()
        {
        ...
        public PersonHeightAndWeightCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
