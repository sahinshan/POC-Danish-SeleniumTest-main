...
{
    public class AllegedVictimPage  : CommonMethods
    {
        public AllegedVictimPage (IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By AllegedVictimFrame = By.Id("CWUrlPanel_IFrame");
        ...
        public AllegedVictimPage  WaitForAllegedVictimPageToLoad()
        {
            ...
            WaitForElement(AllegedVictimFrame);
            SwitchToIframe(AllegedVictimFrame);
        ...
        public AllegedVictimPage  ClickNewRecordButton()
        {
        ...
        public AllegedVictimPage  ValidateNoRecordMessageVisibile(bool ExpectedText)
        {
            if (ExpectedText)
        ...
        public AllegedVictimPage  ValidateRecordCellText(string RecordID, int CellPosition, string ExpectedText)
        {
        ...
        public AllegedVictimPage  SelectViewSelector(String TextToSelect)
        {
        ...
        public AllegedVictimPage  SelectAllegedVictimPageRecord(string RecordId)
        {
        ...
        public AllegedVictimPage  OpenAllegationAbuserRecord(string RecordId)
        {
        ...
        public AllegedVictimPage  ValidateRecordPosition(int ElementPosition, string RecordID)
        {
        ...
        public AllegedVictimPage  SearchRecord(string SearchQuery)
        {
        ...
        public AllegedVictimPage  ClickAssignButton()
        {
        ...
        public AllegedVictimPage  ClickExportToExcelButton()
        {
