...
{
    public class AllegedAbsuserRecordPage : CommonMethods
    {
        public AllegedAbsuserRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        public AllegedAbsuserRecordPage WaitForAllegedAbsuserRecordPageToLoad(string TaskTitle)
        {
        ...
        public AllegedAbsuserRecordPage ClickSaveButton()
        {
        ...
        public AllegedAbsuserRecordPage ClickSaveAndCloseButton()
        {
        ...
        public AllegedAbsuserRecordPage NavigateAllegationInvestigatorsSubpage()
        {
