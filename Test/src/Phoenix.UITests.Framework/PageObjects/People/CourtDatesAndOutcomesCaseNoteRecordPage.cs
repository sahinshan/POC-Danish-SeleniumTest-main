...
{
    public class CourtDatesAndOutcomesCaseNoteRecordPage : CommonMethods
    {

        public CourtDatesAndOutcomesCaseNoteRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By iframe_CWDialog = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=mhacourtdateoutcomecasenote')]");
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage WaitForCourtDatesAndOutcomesCaseNoteRecordPageToLoad()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ValidateContainsInformationProvidedByThirdPartyFieldVisibility(bool ExpectVisible)
        {
            if (ExpectVisible)
            {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickNotesFieldSpellCheckButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage InsertSubject(string TextToInsert)
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickResponsibleTeamRemoveButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickResponsibleTeamLookupButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickResponsibleUserRemoveButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickResponsibleUserLookupButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickSaveAndCloseButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickCloneButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ClickBackButton()
        {
        ...
        public CourtDatesAndOutcomesCaseNoteRecordPage ValidateResponsibleTeamLinkFieldText(string ExpectedText)
        {
