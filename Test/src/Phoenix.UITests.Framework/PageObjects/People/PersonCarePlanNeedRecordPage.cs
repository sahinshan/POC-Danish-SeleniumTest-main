...
{
    public class PersonCarePlanNeedRecordPage : CommonMethods
    {
        public PersonCarePlanNeedRecordPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By personCarePlanNeedRecordIFrame = By.XPath("//iframe[contains(@id,'iframe_CWDialog_')][contains(@src,'type=personcareplanneed&')]");
        #endregion
        ...
        public PersonCarePlanNeedRecordPage WaitForPersonCarePlanNeedRecordPageToLoad()
        {
            ...
            WaitForElement(personCarePlanNeedRecordIFrame);
            SwitchToIframe(personCarePlanNeedRecordIFrame);
        ...
        public PersonCarePlanNeedRecordPage TapGoalROutcomeLink()
        {
