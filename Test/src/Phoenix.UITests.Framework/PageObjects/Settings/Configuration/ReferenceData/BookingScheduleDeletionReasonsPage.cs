...
{
    public class BookingScheduleDeletionReasonsPage : CommonMethods
    {
        public BookingScheduleDeletionReasonsPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        readonly By BookingScheduleDeletionReasonsPageHeader = By.XPath("//*[@id='CWToolbar']/div/h1[text()='Booking Schedule Deletion Reasons']");
        ...
        public BookingScheduleDeletionReasonsPage WaitForBookingScheduleDeletionReasonsPageToLoad()
        {
            ...
            WaitForElementVisible(BookingScheduleDeletionReasonsPageHeader);
        ...
        public BookingScheduleDeletionReasonsPage SelectSystemView(string ExpectedTextToSelect)
        {
        ...
        public BookingScheduleDeletionReasonsPage ValidateSelectedSystemView(string ExpectedText)
        {
            WaitForElementToBeClickable(viewSelector);
            MoveToElementInPage(viewSelector);
        ...
        public BookingScheduleDeletionReasonsPage InsertSearchQuery(string SearchQuery)
        {
        ...
        public BookingScheduleDeletionReasonsPage TapSearchButton()
        {
        ...
        public BookingScheduleDeletionReasonsPage ValidateRecordCellContent(string RecordId, int CellPosition, string ExpectedText)
        {
        ...
        public BookingScheduleDeletionReasonsPage ClickNewRecordButton()
        {
        ...
        public BookingScheduleDeletionReasonsPage OpenRecord(string RecordID)
        {
        ...
        public BookingScheduleDeletionReasonsPage ValidateNoRecordsMessageVisible()
        {
