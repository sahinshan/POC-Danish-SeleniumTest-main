...
{
    public class GenericWebSiteUsersPage : CommonMethods
    {
        public GenericWebSiteUsersPage(IWebDriver driver, OpenQA.Selenium.Support.UI.WebDriverWait Wait, string appURL)
        {
            this.driver = driver;
            this.Wait = Wait;
            this.appURL = appURL;
        ...
        //readonly By CWNavItem_WebsiteUserFrame = By.Id("CWNavItem_WebsiteUserFrame");
        ...
        By userNameCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[3]");
        By profileCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[4]");
        By statusCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[5]");
        By securityProfileCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[6]");
        By lastLoginDateCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[7]");
        By createdByCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[8]");
        By createdOnCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[9]");
        By modifiedByCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[10]");
        By modifiedOnCell(string recordID) => By.XPath("//*[@id='" + recordID + "']/td[11]");
        ...
        public GenericWebSiteUsersPage WaitForGenericWebSiteUsersPageToLoad()
        {
        ...
        public GenericWebSiteUsersPage SelectView(string ViewText)
        {
        ...
        public GenericWebSiteUsersPage ValidateWebsiteCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(websiteCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateUserNameCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(userNameCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateProfileCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(profileCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateStatusCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(statusCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateSecurityProfileCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(securityProfileCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateLastLoginDateCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(lastLoginDateCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateCreatedByCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(createdByCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateCreatedOnCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(createdOnCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateModifiedByCellText(string RecordID, string ExpectedText)
        {
            ValidateElementText(modifiedByCell(RecordID), ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ValidateModifiedOnCellText(string RecordID, string ExpectedText)
        {
        ...
        public GenericWebSiteUsersPage ClickOnWebSiteUserRecord(string RecordID)
        {
        ...
        public GenericWebSiteUsersPage ValidateRecordPresent(string RecordID)
        {
            WaitForElementToBeClickable(websiteRecordCheckbox(RecordID));

            return this;
        }
        public GenericWebSiteUsersPage ValidateRecordNotPresent(string RecordID)
        {
        ...
        public GenericWebSiteUsersPage InsertSearchQuery(string SearchQuery)
        {
            SendKeys(quickSearchTextBox, SearchQuery);

            return this;
        }
        public GenericWebSiteUsersPage ClickSearchButton()
        {
        ...
        public GenericWebSiteUsersPage ClicAddNewRecordButton()
        {
        ...
        public GenericWebSiteUsersPage ClickFirstPageButton()
        {
        ...
        public GenericWebSiteUsersPage ClickPreviousPageButton()
        {
        ...
        public GenericWebSiteUsersPage ValidateCurrentPageInfo(string ExpectedText)
        {
            ValidateElementText(PageNumber_Button, ExpectedText);

            return this;
        }
        public GenericWebSiteUsersPage ClickNextPageButton()
        {
