...
namespace CareDirectorApp.UITests.People.Finance
{
    ...
    public class PersonFinancialDetails_OfflineTabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6791")]
        ...
        public void PersonFinancialDetails_OfflineTestMethod02()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6792")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
        ...
        public void PersonFinancialDetails_OfflineTestMethod03()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6793")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
        ...
        public void PersonFinancialDetails_OfflineTestMethod04()
        {
            Guid personID = new Guid("3301e8c2-4591-ea11-a2cd-005056926fe4"); //Pavel MCNamara
            Guid personFinancialDetailID = new Guid("df30bc95-c804-eb11-a2cd-005056926fe4"); //AE (Multiple Rates)
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6794")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            ...
            "Open the person financial detail record - Validate that the record is correctly displayed.")]
        public void PersonFinancialDetails_OfflineTestMethod05()
        {
            Guid personID = new Guid("3301e8c2-4591-ea11-a2cd-005056926fe4"); //Pavel MCNamara
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6796")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            ...
            "Open the person financial detail record - Validate that the record is correctly displayed.")]
        public void PersonFinancialDetails_OfflineTestMethod08()
        {
            Guid personID = new Guid("3301e8c2-4591-ea11-a2cd-005056926fe4"); //Pavel MCNamara
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6797")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            ...
            "Open the person financial detail record - Validate that the record is correctly displayed.")]
        public void PersonFinancialDetails_OfflineTestMethod09()
        {
            Guid personID = new Guid("3301e8c2-4591-ea11-a2cd-005056926fe4"); //Pavel MCNamara
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6799")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Person has an Allowable Expense (multiple rates) person financial detail - Open a person record - navigate to the person financial details page - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod11()
        {
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6800")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Person has an Allowable Expense (multiple rates) person financial detail - Open a person record - navigate to the person financial details page - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod12()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6801")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            ...
            "Open the person financial detail record - Update all editable fields - Save the record - Validate that the changes are saved in the database")]
        public void PersonFinancialDetails_OfflineTestMethod13()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6802")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Person has an Asset person financial detail - Open a person record - navigate to the person financial details page - " +
            "Open the person financial detail record - Update all editable fields - Save the record - Validate that the changes are saved in the database")]
        public void PersonFinancialDetails_OfflineTestMethod14()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
            ...
            var startdatefield = this.PlatformServicesHelper.personFinancialDetail.GetPersonFinancialDetailByID(personFinancialDetailID, "startdate");
            var enddatefield = this.PlatformServicesHelper.personFinancialDetail.GetPersonFinancialDetailByID(personFinancialDetailID, "enddate");

            var usersettings = PlatformServicesHelper.GetMetadataUserSettings();

            var dateConverted = usersettings.ConvertTimeFromUtc((DateTime)startdatefield["startdate"]);
            string Startdate = dateConverted.Value.ToString("dd'/'MM'/'yyyy HH:mm");

            var dateConverted1 = usersettings.ConvertTimeFromUtc((DateTime)enddatefield["startdate"]);
            string EndDate = dateConverted1.Value.ToString("dd'/'MM'/'yyyy HH:mm");
            ...
            Assert.AreEqual(newStartDate.ToString("dd'/'MM'/'yyyy HH:mm"), Startdate);//updated
            Assert.AreEqual(newEndDate.ToString("dd'/'MM'/'yyyy HH:mm"), EndDate);//updated
            Assert.AreEqual(financialdetailtypeid, fields["financialdetailtypeid"]);
            Assert.AreEqual(newReference, fields["reference"]); //updated
            Assert.AreEqual(newAmount, fields["amount"]); //updated
            Assert.AreEqual(newJointAmount, fields["jointamount"]); //update
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6803")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Person has an Benefit & Income (multiple rates) person financial detail - Open a person record - navigate to the person financial details page - " +
            "Open the person financial detail record - Update all editable fields - Save the record - Validate that the changes are saved in the database")]
        public void PersonFinancialDetails_OfflineTestMethod15()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6804")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            ...
            "Open the person financial detail record - Update all editable fields - Save the record - Validate that the changes are saved in the database")]
        public void PersonFinancialDetails_OfflineTestMethod16()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6805")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Person has an Property person financial detail - Open a person record - navigate to the person financial details page - " +
            "Open the person financial detail record - Update all editable fields - Save the record - Validate that the changes are saved in the database")]
        public void PersonFinancialDetails_OfflineTestMethod17()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6806")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
        ...
        public void PersonFinancialDetails_OfflineTestMethod18()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6807")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod19()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6808")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
            "Select Allowable Expense as the detail type - select 'AE (Multiple Rates)' as the financial detail - Set values for Amount and remaining fields - " +
            "Tap on the save button - Validate that the record is correctly saved")]
        public void PersonFinancialDetails_OfflineTestMethod20()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6809")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
            ...
            "Tap on the save button - Validate that the record is correctly saved")]
        public void PersonFinancialDetails_OfflineTestMethod21()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6810")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
            ...
            "Tap on the save button - Validate that the record is correctly saved")]
        public void PersonFinancialDetails_OfflineTestMethod22()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6811")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
            ...
            "Tap on the save button - Validate that the record is correctly saved")]
        public void PersonFinancialDetails_OfflineTestMethod23()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6813")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod25()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6814")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod26()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6815")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod28()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6816")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod29()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6817")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod30()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6818")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
            "Open a person record - navigate to the person financial details page - Tap on the Add new record button - " +
        ...
        public void PersonFinancialDetails_OfflineTestMethod32()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
            ...
            Assert.AreEqual(0M, fields["grossvalue"]);
            Assert.AreEqual(0, fields["percentageownership"]);
        }
        ...
        [Test]
        [Property("JiraIssueID", "CDV6-6819")]
        [Description("https://advancedcsg.atlassian.net/browse/CDV6-4875" +
        ...
        public void PersonFinancialDetails_OfflineTestMethod31()
        {
            var personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline
