...
namespace CareDirectorApp.UITests.People.Health
{
    ...
    public class PersonDDNARRecords_TabletModeTests : TestBase
    {
        ...
        public void PersonDNARRecords_TestMethod01()
        {
        ...
        public void PersonVerifyDNARActiveRecords_TestMethod02()
        {
            ...
            personDNARRecordPage
                .WaitForPersonDNARRecordPageToLoad("RECORDS OF DNAR")
               // .ValidateRecordPresent("Pavel MCNamara")
        ...
        public void PersonVerifyDNARActiveRecords_TestMethod03()
        {
            ...
            DateTime completeddate = DateTime.Now;
            DateTime DNARDateTime = DateTime.Now;
           // DateTime cancelleddate = DateTime.UtcNow;;
            ...
            //String CancelledDate1 = ((DateTime)datefield["cancelleddate"]);
