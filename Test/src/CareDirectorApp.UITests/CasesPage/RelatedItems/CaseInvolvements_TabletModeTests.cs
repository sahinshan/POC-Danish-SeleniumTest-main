...
namespace CareDirectorApp.UITests.Cases.RelatedItems
{
    ...
    public class CaseInvolvements_TabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6572")]
        ...
        public void CaseInvolvements_TestMethod02()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6573")]
        ...
        public void CaseInvolvements_TestMethod03()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6574")]
        [Description("UI Test for Case Involvements - 0004 - " +
            "Navigate to the Case Involvements area - Open a cases case attachment record - Validate that the case attachment record page field titles are displayed")]
        public void CaseInvolvements_TestMethod04()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            string involvementMember = "Mobile Test User 1";
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6575")]
        [Description("UI Test for Case Involvements - 0005 - " +
            "Navigate to the Case Involvements area - Open a cases case attachment record - Validate that the case attachment record page fields are correctly displayed")]
        public void CaseInvolvements_TestMethod05()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            string involvementMember = "Mobile Test User 1";
