...
namespace CareDirectorApp.UITests.Cases.RelatedItems
{
    ...
    public class CaseAttachments_OfflineTabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6517")]
        [Description("UI Test for Case Attachments (Offline Mode) - 0002 - " +
            "Navigate to the Case Attachments area (case contains case attachment records) - Validate the page content")]
        public void CaseAttachments_OfflineTestMethod02()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6518")]
        [Description("UI Test for Case Attachments (Offline Mode) - 0004 - " +
            "Navigate to the Case Attachments area - Open a cases case attachment record - Validate that the case attachment record page fields and titles are displayed")]
        public void CaseAttachments_OfflineTestMethod04()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6519")]
        [Description("UI Test for Case Attachments (Offline Mode) - 0010 - " +
        ...
        public void CaseAttachments_OfflineTestMethod10()
        {
            ...
            lookupPopup.WaitForLookupPopupToLoad().TapOnRecord("Bladder Scan");

            caseAttachmentRecordPage
                .WaitForCaseAttachmentRecordPageToLoad("ATTACHMENTS (FOR CASE)")
                .TapDocumentSubTypeLookupButton();

            lookupPopup.WaitForLookupPopupToLoad().TapOnRecord("Bladder Scan Results");
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6520")]
        [Description("UI Test for Case Attachments (Offline Mode) - 0017 - Create a new cases case attachment using the main APP web services" +
            "Navigate to the Case Attachments area - open the case attachment record - validate that all fields are correctly synced")]
        public void CaseAttachments_OfflineTestMethod17()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6521")]
        [Description("UI Test for Case Attachments (Offline Mode) - 0019 - Create a new cases case attachment using the main APP web services" +
        ...
        public void CaseAttachments_OfflineTestMethod19()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6522")]
        [Description("UI Test for Case Attachments (Offline Mode) - 0020 - Create a new cases case attachment using the main APP web services" +
        ...
        public void CaseAttachments_OfflineTestMethod20()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
