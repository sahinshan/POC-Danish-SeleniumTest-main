...
namespace CareDirectorApp.UITests.Cases.Health
{
    ...
    public class CaseHealthAppointmentTasks_OfflineTabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6513")]
        [Description("UI Test for Health Appointment Task records (Offline Mode) - 0001 - " +
        ...
        public void healthAppointmentTasks_OfflineTestMethod01()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6514")]
        [Description("UI Test for Health Appointment Task records (Offline Mode) - 0002 - Create a new health Appointment Task using the main APP web services" +
        ...
        public void healthAppointmentTasks_OfflineTestMethod02()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            Guid healthAppointmentID = new Guid("ade9ebb8-1db6-ea11-a2cd-005056926fe4");
            string appointmentDate = "01/06/2020";
