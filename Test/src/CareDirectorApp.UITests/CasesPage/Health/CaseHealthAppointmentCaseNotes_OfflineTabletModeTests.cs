...
namespace CareDirectorApp.UITests.Cases.Health
{
    ...
    public class CaseHealthAppointmentCaseNotes_OfflineTabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6473")]
        [Description("UI Test for Health Appointments Case Notes (Offline Mode) - 0001 - " +
        ...
        public void HealthAppointmentsCaseNotes_OfflineTestMethod1()
        {
            ...
            lookupPopup.WaitForLookupPopupToLoad().TapOnRecord("Therapy group");
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6474")]
        [Description("UI Test for Health Appointments Case Notes (Offline Mode) - 002 - Create a new cases case note using the main APP web services" +
        ...
        public void HealthAppointmentsCaseNotes_OfflineTestMethod2()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            Guid healthAppointmentID = new Guid("ade9ebb8-1db6-ea11-a2cd-005056926fe4");
