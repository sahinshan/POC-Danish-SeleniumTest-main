...
namespace CareDirectorApp.UITests.Cases
{
    ...
    public class CaseTasks_TabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6438")]
        [Description("UI Test for Case tasks - 0001 - " +
            "Navigate to the cases Tasks area (case do not contains Task records) - Validate the page content")]
        public void CaseTasks_TestMethod01()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6439")]
        [Description("UI Test for Case tasks - 0002 - " +
            "Navigate to the cases Tasks area (case contains Task records) - Validate the page content")]
        public void CaseTasks_TestMethod02()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6440")]
        [Description("UI Test for Case tasks - 0003 - " +
            "Navigate to the cases Tasks area - Open a cases Task record - Validate that the Task record page is displayed")]
        public void CaseTasks_TestMethod03()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6441")]
        [Description("UI Test for Case tasks - 0004 - " +
            "Navigate to the cases Tasks area - Open a cases Task record - Validate that the Task record page field titles are displayed")]
        public void CaseTasks_TestMethod04()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            string TaskSubject = "Task 001";
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6442")]
        [Description("UI Test for Case tasks - 0005 - " +
            "Navigate to the cases Tasks area - Open a cases Task record - Validate that the Task record page fields are correctly displayed")]
        public void CaseTasks_TestMethod05()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            string TaskSubject = "Task 001";
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6443")]
        [Description("UI Test for Case tasks - 0006 - " +
            "Navigate to the cases Tasks area - Open a cases Task record (with only the mandatory information set) - Validate that the Task record page fields are correctly displayed")]
        public void CaseTasks_TestMethod06()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
            ...
            caseTaskRecordPage
                .WaitForCaseTaskRecordPageToLoad("TASK: Task 002")
                .ValidateSubjectFieldText(TaskSubject)
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6444")]
        [Description("UI Test for Case tasks - 0007 - " +
            "Navigate to the cases Tasks area - Tap on the add button - Validate that the new record page is displayed and all field titles are visible ")]
        public void CaseTasks_TestMethod07()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6445")]
        [Description("UI Test for Case tasks - 0008 - " +
            "Navigate to the cases Tasks area - Tap on the add button - Validate that the new record page is displayed but the delete button is not displayed")]
        public void CaseTasks_TestMethod08()
        {
            Guid caseID = new Guid("2b992f0d-4791-ea11-a2cd-005056926fe4"); //Mr Pavel MCNamara 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6446")]
        [Description("UI Test for Case tasks - 0009 - " +
        ...
        public void CaseTasks_TestMethod09()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            ...
            DateTime ExpectedDueDate = new DateTime(2020, 5, 20, 9, 0, 0);

            var ExpectedDueDatefield1 = ExpectedDueDate.ToString("dd'/'MM'/'yyyy HH:mm");
            ...
            Assert.AreEqual(ExpectedDueDatefield1, ActualDuedate);
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6447")]
        [Description("UI Test for Case tasks - 0010 - " +
            "Navigate to the cases Tasks area - Tap on the add button - Set data in all fields - " +
            "Tap on the Save & Close button - Validate that the data is sync to the web platform")]
        public void CaseTasks_TestMethod10()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6449")]
        [Description("UI Test for Case tasks - 0012 - " +
            "Navigate to the cases Tasks area - Tap on the add button - Set data only in mandatory fields - " +
            "Tap on the Save button - Validate that the data is sync to the web platform")]
        public void CaseTasks_TestMethod12()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6450")]
        [Description("UI Test for Case tasks - 0013 - " +
            "Navigate to the cases Tasks area - Tap on the add button - Set data only in mandatory fields except for Subject- " +
            "Tap on the Save button - Validate that the user is prevented from saving the record")]
        public void CaseTasks_TestMethod13()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6451")]
        [Description("UI Test for Case tasks - 0014 - " +
            "Navigate to the cases Tasks area - Tap on the add button - Set data only in mandatory fields except for Responsible Team - " +
            "Tap on the Save button - Validate that the record is saved and the Responsible Team field is set with the user team")]
        public void CaseTasks_TestMethod14()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            ...
            var fields = this.PlatformServicesHelper.task.GetTaskByID(caseNotes[0], "ownerid");
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6452")]
        [Description("UI Test for Case tasks - 0015 - Create a new cases Task using the main APP web services" +
            "Navigate to the cases Tasks area - open the Task record - validate that all fields are correctly synced")]
        public void CaseTasks_TestMethod15()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6453")]
        [Description("UI Test for Case tasks - 0016 - Create a new cases Task using the main APP web services" +
        ...
        public void CaseTasks_TestMethod16()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Tsatsouline, Maria - (01/05/1960) [CAS-000004-6176] 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
            ...
            var DueDateConverted = usersettings.ConvertTimeFromUtc((DateTime)datefield["duedate"]);
            string ActualDueDate = DueDateConverted.Value.ToString("dd'/'MM'/'yyyy HH:mm");

            DateTime date1 = new DateTime(2020, 5, 20, 9, 0, 0);

            var ExpectedDueDatefield1 = date1.ToString("dd'/'MM'/'yyyy HH:mm");
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6454")]
        [Description("UI Test for Case tasks - 0017 - Create a new cases Task using the main APP web services" +
            "Navigate to the cases Tasks area - open the Task record - update all fields - Tap on the save button - " +
            "Validate that the record is correctly saved and synced")]
        public void CaseTasks_TestMethod17()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
            ...
            DateTime date1 = new DateTime(2020, 5, 21, 9, 30, 0);
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6455")]
        [Description("UI Test for Case tasks - 0018 - Create a new cases Task using the main APP web services" +
        ...
        public void CaseTasks_TestMethod18()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6456")]
        [Description("UI Test for Case tasks - 0019 - Create a new cases Task using the main APP web services" +
            "Navigate to the cases Tasks area - open the Task record - Set the status to Canceled - Save the record - Validate that the record gets deactivated")]
        public void CaseTasks_TestMethod19()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6457")]
        [Description("UI Test for Case tasks - 0021 - Create a new cases Task using the main APP web services" +
            "Navigate to the cases Tasks area - open the Task record - Set the status to Canceled - Save the record - Validate that the record is no longer editable")]
        public void CaseTasks_TestMethod21()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
            ...
            caseTasksPage
               .WaitForCaseTasksPageToLoad("Inactive Tasks")
               .TapOnRecord("Task 001");
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6458")]
        [Description("UI Test for Case tasks - 0020 - Create a new cases Task using the main APP web services" +
        ...
        public void CaseTasks_TestMethod20()
        {
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Ms Maria Tsatsouline 
            Guid mobile_test_user_1UserID = new Guid("2B16C2F3-459E-E911-A2C6-005056926FE4"); //mobile_test_user_1U
