...
namespace CareDirectorApp.UITests.Appointments
{
    ...
    public class AppointmentsPage_OfflineTabletModeTests : TestBase
    {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6389")]
        [Description("UI Test for the Appointments page (Offline Mode) - 001 - " +
        ...
        public void AppointmentsPage_OfflineTestMethod001()
        {
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6390")]
        [Description("UI Test for the Appointments page (Offline Mode) - 002 - " +
        ...
        public void AppointmentsPage_OfflineTestMethod002()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6391")]
        [Description("UI Test for the Appointments page (Offline Mode) - 003 - " +
        ...
        public void AppointmentsPage_OfflineTestMethod003()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6392")]
        [Description("UI Test for the Appointments page (Offline Mode) - 004 - " +
        ...
        public void AppointmentsPage_OfflineTestMethod004()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6393")]
        [Description("UI Test for the Appointments page (Offline Mode) - 005 - " +
        ...
        public void AppointmentsPage_OfflineTestMethod005()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
        ...
        /// </summary>
        [Test]
        [Property("JiraIssueID", "CDV6-6394")]
        [Description("UI Test for the Appointments page (Offline Mode) - 006 - " +
        ...
        public void AppointmentsPage_OfflineTestMethod006()
        {
            Guid caseID = new Guid("0e22b6e2-9a93-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
            Guid personID = new Guid("0e62da4b-4591-ea11-a2cd-005056926fe4"); //Maria Tsatsouline 
