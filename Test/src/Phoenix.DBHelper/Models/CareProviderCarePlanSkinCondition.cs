...
namespace Phoenix.DBHelper.Models
{
    ...
    public class CareProviderCarePlanSkinCondition : BaseClass
    {
        private string TableName = "CareProviderCarePlanSkinCondition";
        private string PrimaryKeyName = "CareProviderCarePlanSkinConditionid";

        public CareProviderCarePlanSkinCondition()
        {
            AuthenticateUser();
        }

        public CareProviderCarePlanSkinCondition(CareDirector.Sdk.ServiceResponse.AuthenticateResponse AuthenticationData)
        {
            SetServiceConnectionDataFromAuthenticationResponse(AuthenticationData);
        }

        public Guid CreateCareProviderCarePlanSkinCondition(string name, DateTime startdate, Guid ownerid)
        {
