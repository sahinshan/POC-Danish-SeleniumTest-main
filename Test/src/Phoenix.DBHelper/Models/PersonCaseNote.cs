...
namespace Phoenix.DBHelper.Models
{
    public class PersonCaseNote : BaseClass
    {
        ...
        public PersonCaseNote()
        {
            AuthenticateUser();
        }

        public PersonCaseNote(CareDirector.Sdk.ServiceResponse.AuthenticateResponse AuthenticationData)
        {
        ...
        /// <returns></returns>
        public void CreateMultipleCaseNoteRecords(int TotalRecordsToCreate, Guid ownerid, List<string> subjects, List<string> notesList,
        ...
        public Guid CreatePersonCaseNote(Guid ownerid, string subject, string notes, Guid personid, DateTime casenotedate)
        {
