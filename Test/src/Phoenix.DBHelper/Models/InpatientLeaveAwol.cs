...
{
    public class InpatientLeaveAwol : BaseClass
    {
        public string TableName { get { return "InpatientLeaveAwol"; } }
        public string PrimaryKeyName { get { return "InpatientLeaveAwolid"; } }


        public InpatientLeaveAwol()
        {
            AuthenticateUser();
        }

        public InpatientLeaveAwol(CareDirector.Sdk.ServiceResponse.AuthenticateResponse AuthenticationData)
        {
        ...
        public Dictionary<string, object> GetByID(Guid InpatientLeaveAwolId, params string[] FieldsToReturn)
        {
            var query = this.GetDataQueryObject(TableName, false, PrimaryKeyName);

            this.AddReturnFields(query, TableName, FieldsToReturn);

            this.BaseClassAddTableCondition(query, PrimaryKeyName, ConditionOperatorType.Equal, InpatientLeaveAwolId);
        ...
        public void DeleteInpatientLeaveAwol(Guid InpatientLeaveAwolid)
        {
            this.DeleteRecord(TableName, InpatientLeaveAwolid);
        }
    }
}
