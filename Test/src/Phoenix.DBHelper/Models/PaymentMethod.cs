...
namespace Phoenix.DBHelper.Models
{
    ...
    {
        public string TableName = "PaymentMethod";
        public string PrimaryKeyName = "PaymentMethodId";
        ...
        public PaymentMethod(CareDirector.Sdk.ServiceResponse.AuthenticateResponse AuthenticationData)
        {
